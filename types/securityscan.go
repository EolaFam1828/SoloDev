...
type (
	SecurityScannerCapability struct {
		Name      string `json:"name"`
		Available bool   `json:"available"`
	}

	SecurityScannerStatus struct {
		Enabled      bool                        `json:"enabled"`
		Ready        bool                        `json:"ready"`
		Capabilities []SecurityScannerCapability `json:"capabilities"`
	}
	...
	ScanResult struct {
		...
		FailureReason string                   `db:"ss_failure_reason" json:"failure_reason,omitempty"`
