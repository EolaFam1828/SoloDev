CREATE TABLE remediations (
    ...
    rem_tokens_used INTEGER NOT NULL DEFAULT 0,
    rem_duration_ms INTEGER NOT NULL DEFAULT 0,
    rem_metadata    TEXT,
    rem_created_by  INTEGER NOT NULL,
    rem_created     INTEGER NOT NULL,
    rem_updated     INTEGER NOT NULL,
    rem_version     INTEGER NOT NULL DEFAULT 1,
