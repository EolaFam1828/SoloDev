...
,ss_space_id             INTEGER NOT NULL
,ss_repo_id              INTEGER NOT NULL
...
,ss_duration             INTEGER NOT NULL DEFAULT 0
,ss_triggered_by         TEXT NOT NULL
,ss_created_by           INTEGER NOT NULL
,ss_created              INTEGER NOT NULL
,ss_updated              INTEGER NOT NULL
,ss_failure_reason       TEXT NOT NULL DEFAULT ''
,ss_version              INTEGER NOT NULL DEFAULT 0
