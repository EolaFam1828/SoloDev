...
,ff_enabled BOOLEAN NOT NULL DEFAULT false
,ff_variations JSONB NOT NULL DEFAULT '[]'
,ff_tags JSONB NOT NULL DEFAULT '[]'
,ff_permanent BOOLEAN NOT NULL DEFAULT false
