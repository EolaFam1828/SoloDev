CREATE TABLE health_check_results (
    hcr_id SERIAL PRIMARY KEY,
    hcr_health_check_id INTEGER NOT NULL,
    hcr_status TEXT NOT NULL,
    hcr_response_time BIGINT NOT NULL DEFAULT 0,
    hcr_status_code INTEGER NOT NULL DEFAULT 0,
    hcr_error_message TEXT NOT NULL DEFAULT '',
    hcr_created_at BIGINT NOT NULL,
    CONSTRAINT fk_health_check_results_health_check_id FOREIGN KEY (hcr_health_check_id)
        REFERENCES health_checks (hc_id) ON DELETE CASCADE
);
