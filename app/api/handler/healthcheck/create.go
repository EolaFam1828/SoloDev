...
func HandleCreate(healthCheckCtrl *healthcheck.Controller) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		hc, err := healthCheckCtrl.Create(ctx, session, spaceRef, in)
		if err != nil {
			render.TranslatedUserError(ctx, w, err)
			return
		}

		render.JSON(w, http.StatusCreated, hc)
	}
}
