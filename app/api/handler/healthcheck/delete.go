...
// HandleDelete returns a http.HandlerFunc that deletes a health check.
func HandleDelete(healthCheckCtrl *healthcheck.Controller) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = healthCheckCtrl.Delete(ctx, session, spaceRef, identifier)
		if err != nil {
			render.TranslatedUserError(ctx, w, err)
			return
		}
